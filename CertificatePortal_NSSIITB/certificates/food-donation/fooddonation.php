...
$jsonData = file_get_contents('/var/www/html/certificates/rivercleanup_data.json');/* need to change here*//////////////////////
...
if (in_array($name, $names)) {
    ...
    if (extension_loaded('gd') && function_exists('gd_info')) {
        ...
        $backgroundImagePath = '/var/www/html/certificates/fooddonation_certificate.png';
